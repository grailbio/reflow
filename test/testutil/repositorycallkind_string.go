...
const _RepositoryCallKind_name = "RepositoryGetRepositoryPutRepositoryStatRepositoryWriteToRepositoryReadFrom"

var _RepositoryCallKind_index = [...]uint8{0, 13, 26, 40, 57, 75}
